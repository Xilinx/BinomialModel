...
int main(int argc, char* argv[])
{
	...
	for (int i=0; i<(SW_HW_Config).NB_OF_KERNELS; i++) {
		...
		//............................................................
		HW_Kernels[i].Nb_Of_Test_Vectors = ROUNDED_NB_OF_TESTS;   // This value is specific for the implementation strategy
	...
	NB_OF_MEM_RD_EVENTS = 1;
	NB_OF_MEM_WR_EVENTS = 1;
	NB_OF_EXE_EVENTS    = 1;
	...
	for (int i=0; i<(SW_HW_Config).NB_OF_KERNELS; i++) {
		...
		errCode |= clSetKernelArg(HW_Kernels[i].kernel,  arg_indx++, sizeof(cl_int),    &(HW_Kernels[i].Nb_Of_Test_Vectors));
		errCode |= clSetKernelArg(HW_Kernels[i].kernel,  arg_indx++, sizeof(cl_int),    &Start_Index);
	...
	// .....................................................................
	// We work with a single Kernel only
	// .....................................................................
	int k_index = 0;

	// .....................................................................
	// Copy ALL test vectors: host_IN_DATA[i] -> host_IBuf
	// .....................................................................
	for (int i=0; i<HW_Kernels[k_index].Nb_Of_Test_Vectors; i++)
		HW_Kernels[k_index].host_IBuf[i] = host_IN_DATA[i];
	...
	errCode = clEnqueueNDRangeKernel(Command_Queue, HW_Kernels[k_index].kernel, 1, NULL, globalSize, localSize,
			                                1, &Mem_wr_event[0], &K_exe_event[0]);
	...
	clWaitForEvents(1,&Mem_rd_event[0]);

	// .................................................................
	// Copy ALL results: host_OBuf -> hw_RES[i]
	// .................................................................
	for (int i=0; i<HW_Kernels[k_index].Nb_Of_Test_Vectors; i++)
        hw_RES[i] = HW_Kernels[k_index].host_OBuf[i];
